...
class Proposers {
  ...
  static Proposition digestProposer(String routine, Digest digest) => Proposition()
  ...
  static Proposition signatureProposer(String routine, VerificationKey vk) => Proposition()
    ..digitalSignature =
  ...
  static Proposition heightProposer(String chain, Int64 min, Int64 max) => Proposition()
  ...
  static Proposition exactMatchProposer(String location, Int8List compareTo) => Proposition()
    ..exactMatch =
  ...
  static Proposition lessThanProposer(String location, Int128 compareTo) => Proposition()
  ...
  static Proposition greaterThanProposer(String location, Int128 compareTo) => Proposition()
    ..greaterThan =
  ...
  static Proposition equalToProposer(String location, Int128 compareTo) => Proposition()
