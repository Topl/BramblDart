...
Either<QuivrRunTimeError, T> quivrEvaluationAuthorizationFailure<T>(proof, proposition) =>
    QuivrResult<T>.left(ValidationError.evaluationAuthorizationFailure(
        proof: proof, proposition: proposition, context: "(${proof.toString}, ${proposition.toString})"));
