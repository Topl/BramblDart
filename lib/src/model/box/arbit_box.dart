...
class ArbitBox extends TokenBox {
  ...
  ArbitBox(Evidence evidence, SimpleValue value, Nonce nonce) : super(value, evidence, nonce, typeString);
  ...
  factory ArbitBox.fromJson(Map<String, dynamic> json) => _$ArbitBoxFromJson(json);
