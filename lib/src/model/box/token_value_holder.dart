...
class TokenValueHolder {
  ...
  factory TokenValueHolder.fromJson(Map<String, dynamic> json) => _$TokenValueHolderFromJson(json);
...
class SimpleValue extends TokenValueHolder {
  ...
  final String type;
  SimpleValue({this.type = 'Simple', required String quantity}) : super(quantity);
  ...
  factory SimpleValue.fromJson(Map<String, dynamic> json) => _$SimpleValueFromJson(json);
...
// bytes (1 version byte + 34 bytes for issuer Address + 8 bytes for asset short name)
  ...
  AssetValue(String quantity, this.assetCode, this.securityRoot, this.metadata, this.type) : super(quantity);
  ...
  factory AssetValue.fromJson(Map<String, dynamic> json) => _$AssetValueFromJson(json);
  ...
  @override
  AssetValue copyWith(
      {AssetCode? assetCode, SecurityRoot? securityRoot, String? metadata, String? type, String? quantity}) {
    return AssetValue(quantity ?? this.quantity, assetCode ?? this.assetCode, securityRoot ?? this.securityRoot,
        metadata ?? this.metadata, type ?? this.type);
  }
  ...
  @override
  int get hashCode {
    return assetCode.hashCode ^ securityRoot.hashCode ^ metadata.hashCode ^ type.hashCode;
  }
}
