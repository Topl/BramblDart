...
class PropositionType {
  ...
  factory PropositionType.curve25519() => const PropositionType('PublicKeyCurve25519', curvePrefix);
  factory PropositionType.ed25519() => const PropositionType('PublicKeyEd25519', defaultPropositionPrefix);
  factory PropositionType.thresholdCurve25519() => const PropositionType('ThresholdCurve255129', curveThresholdPrefix);
  ...
  factory PropositionType.fromJson(Map<String, dynamic> json) => _$PropositionTypeFromJson(json);
