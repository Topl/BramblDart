...
// sealed class ContainsSignable<T> {
//   SignableBytes signableBytes(T t);
// }

// class ImmutableSignable implements ContainsSignable<ImmutableBytes> {
//   @override
//   SignableBytes signableBytes(ImmutableBytes t) => SignableBytes(value: t.value);
// }

// class IOTransactionSignable implements ContainsSignable<IoTransaction> {
//   /// Strips the proofs from a SpentTransactionOutput.
//   /// This is needed because the proofs are not part of the transaction's signable bytes
//   @override
//   SignableBytes signableBytes(IoTransaction iotx) {
//     SpentTransactionOutput stripInput(SpentTransactionOutput stxo) {
//       final attestation = stxo.attestation;
//       if (attestation.hasPredicate()) {
//         final predicate = attestation.predicate;
...
//     final ib = ImmutableBytes.fromBuffer(strippedTransaction.writeToBuffer());

//     return ImmutableSignable().signableBytes(ib);
//   }
// }
