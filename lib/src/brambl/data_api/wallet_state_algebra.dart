...
abstract class WalletStateAlgebra {
  ...
  Future<void> initWalletState(int networkId, int ledgerId, VerificationKey vk);
  ...
  Future<Indices?> getIndicesBySignature(Proposition_DigitalSignature signatureProposition);
  ...
  Future<Preimage?> getPreimage(Proposition_Digest digestProposition);
  ...
  Future<Indices?> getCurrentIndicesForFunds(String party, String contract, int? someState);
  ...
  Future<(String, Indices)?> validateCurrentIndicesForFunds(String party, String contract, int? someState);
  ...
  Future<Indices?> getNextIndicesForFunds(String party, String contract);
  ...
  Future<Lock_Predicate?> getLockByIndex(Indices indices);
  ...
  Future<void> addNewLockTemplate(String contract, LockTemplate lockTemplate);
  ...
  Future<LockTemplate?> getLockTemplate(String contract);
  ...
  Future<Lock?> getLock(String party, String contract, int nextState);
}
