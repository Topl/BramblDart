...
/// transaction that would modify it, the Bifrost client can read that data
...
class BlockNum {
  ...
  /// Use the state of the blockchain as of the latest forged block.
  ...
  /// Generates the block parameter as it is accepted by the Bifrost client.
  String toBlockParam() {
